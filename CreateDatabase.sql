...
CONSTRAINT FK_PRODUITS_TVA FOREIGN KEY (IDTVA) REFERENCES TVA(ID)
);
...
CONSTRAINT FK_ELEMENTPANIER_TVA FOREIGN KEY(IDTVA) REFERENCES TVA(ID)
);
...
CONSTRAINT FK_LIGNE_CDE_PRODUITS FOREIGN KEY(IDPRODUIT) REFERENCES PRODUITS(ID),
CONSTRAINT FK_LIGNE_CDE_TVA FOREIGN KEY(IDTVA) REFERENCES TVA(ID)
);
...
CONSTRAINT FK_LIGNE_FACT_PRODUITS FOREIGN KEY(IDPRODUIT) REFERENCES PRODUITS(ID),
CONSTRAINT FK_LIGNE_FACT_TVA FOREIGN KEY (IDTVA) REFERENCES TVA(ID)
);
